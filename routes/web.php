...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/digital-assets/edit/{id}', [DigitalAssetController::class, 'edit'])->name('digitalAssets.edit');
    Route::post('/digital-assets/update/{id}', [DigitalAssetController::class, 'update'])->name('digitalAssets.update');
